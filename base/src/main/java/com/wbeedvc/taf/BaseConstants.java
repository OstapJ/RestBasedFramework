...
public class BaseConstants {
    ...
    public static final String ASSERTION_STATUS_CODE = "Response status code doesn't match to the expected one";
    public static final String ASSERTION_RESPONSE = "%s information response doesn't match to the expected one";
